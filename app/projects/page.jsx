...
import cplusplus from "../assets/projects/C++.webp";
    ...
    return (
        <PageTrasition ref={ref}>
            ...
            <div className="flex min-h-screen flex-col items-center w-full overflow-x-hidden overflow-y-auto">
                ...
                {/* Tools Section  */}
                <div
                    className="relative flex flex-col space-y-[8%] md:space-y-0 pt-[8%] md:justify-between md:items-center md:py-0 w-full">
                    ...
                    >
                        <div
                            className="h-full flex flex-col justify-between items-start space-y-14 md:space-y-8 lg:space-y-14">
                        ...
                        <div className="flex flex-col justify-center space-y-4 items-center">
                            <div
                                className="flex flex-col md:flex-row justify-start pl-[1%] items-center space-y-4 md:space-y-0 md:space-x-8 w-full">
                                {skills.Frameworks.map((item, index) => {
                                    return (
                                        <Image
                                            src={item}
                    ...
                    <div className="w-screen bg-dark lg:flex lg:flex-col lg:items-center">
                        <div
                            className="flex flex-col justify-center items-center px-10  pb-[5%] space-y-6 w-full lg:w-[1150px]">
                            <motion.div
                                initial={fadeIn}
                                whileInView={fadeOut}
                                viewport={{once: true, threshold: 0.5}}
